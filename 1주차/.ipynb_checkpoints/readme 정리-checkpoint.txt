...
-	값을 예측, 물체 인지, 음성 인식, 이미지 인식, 객체 인식 등(분류 , 회귀, 인식)
2. 인공지능의 종류 3가지에 대해서 설명하시오 (지도학습, 반지도학습, 강화학습)
-	지도 학습: 정답이 있는 것 
반지도 학습 : 정답이 없는 것과 있는 것을 섞음
강화 학습 : 보상을 통해 학습을 진해
3. 전통적인 프로그래밍 방법과 인공지능 프로그램의 차이점은 무엇인가?
 - 전통적인 프로그램과 인공지능의 차이점 : 프로그래머가 규칙을 준다. ai는 input, output 을 가지고 규칙을 찾는다.
4. 딥러닝과 머신러닝의 차이점은 무엇인가?
- 딥러닝 : 모델 안에서 특징 추출과 학습을 같이 진행
머신 러닝 : 특징을 추출해서 입력
...
차원의 저주: 차원이 증가할 수록 데이터 분석의 효율이 떨어짐 – feature를 줄인다.  L1,L2 규제 

7.	Dimensionality Reduction는 왜 필요한가?
너무 많은 차원은 분석의 효율이 떨어지기 때문에 

8.	Ridge 와 lasso의 차이점 

9.	Overfitting vs. Underfitting
오버피팅 : 과도하게 학습된 것, 노이즈 ,아웃 라이너, 등등 잘못된 데이터도 학습되는 현상 – 모델을 단순하게 만든다, 규제
...
원핫 인코딩 – 컴퓨터는 0,1 사이의 값을 인식 (종속성을 없애기 위해)
